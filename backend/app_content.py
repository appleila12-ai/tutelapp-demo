...
APP_CONTENT_SEED = {
    ...
    "dopoVerbale": [
        ...
        },
        {
            ...
            "come": "Invia la domanda telematica all'INPS (online con SPID o con l'aiuto dei Servizi Sociali del Comune) e consegna copia del verbale all'ufficio del personale. Con l'accoglimento, il datore non può rifiutare i 3 giorni al mese: si concorda solo la programmazione.",
        },
        {
        ...
        },
        {
            ...
            "come": "Dopo il verbale, l'INPS chiede i dati di pagamento con il modello AP70 (si compila online sul sito INPS). Se dopo 3-4 mesi non arriva nulla, fai un sollecito all'INPS.",
        },
        {
    ...
    "faq": [
        {"d": "Quanto tempo ci mette l'INPS a convocare la visita?", "r": "In media 2-4 mesi dalla domanda (l'obiettivo di legge è 90 giorni, 15 per i malati oncologici). Se tarda troppo, puoi inviare un sollecito all'INPS."},
        ...
        {"d": "I permessi 104 valgono per assistere due familiari?", "r": "Sì, in casi particolari è possibile il cumulo (es. genitore e coniuge): servono i requisiti per ciascuno. Chiedi conferma all'INPS per il tuo caso."},
        ...
        {"d": "Quanto costa farsi aiutare con la pratica?", "r": "Nulla: la domanda all'INPS è gratuita e i Servizi Sociali del Comune offrono un primo orientamento senza costi."},
        {"d": "La percentuale riconosciuta è più bassa del previsto: che faccio?", "r": "Puoi chiedere il riesame o fare ricorso al giudice (ATP) entro 6 mesi dal verbale. Nel frattempo raccogli referti aggiornati. La richiesta di riesame all'INPS è gratuita."},
        {"d": "Cos'è la Riforma della Disabilità 2027?", "r": "Dal 2027 (D.Lgs. 62/2024) in tutta Italia: basta il certificato del medico per avviare la pratica, la visita è solo INPS e si valuta l'impatto sulla vita quotidiana, non solo la percentuale."},
        ...
        {"d": "Come funziona la nuova valutazione unica?", "r": "Il tuo medico invia il certificato introduttivo e la pratica parte da sola: niente più domanda amministrativa separata. Una sola visita e un solo verbale. Puoi anche chiedere il Progetto di Vita personalizzato."},
    ],
    "glossario": [
        {"t": "Verbale unico", "d": "Il documento finale della Valutazione di Base INPS: riconosce insieme invalidità e condizione di disabilità e indica il livello di sostegno."},
        {"t": "Certificato medico introduttivo", "d": "Il certificato del medico che avvia da solo la pratica: con la riforma non serve più una domanda separata."},
        {"t": "Valutazione di Base", "d": "L'unico accertamento INPS che sostituisce le vecchie visite separate di invalidità civile e Legge 104."},
        {"t": "Progetto di Vita", "d": "Il piano personalizzato che coordina sostegni sanitari, sociali, scuola, lavoro e vita indipendente."},
        {"t": "Art. 3 comma 3 (L. 104)", "d": "La dicitura che indica disabilità GRAVE: è quella che dà diritto a permessi e congedi."},
        {"t": "UVM", "d": "Unità di Valutazione Multidimensionale: con i Servizi Sociali del Comune costruisce il Progetto di Vita."},
        ...
        {"t": "Congedo straordinario", "d": "Fino a 2 anni retribuiti per assistere un familiare convivente con disabilità grave."},
        ...
        {"t": "Riforma disabilità (D.Lgs 62/2024)", "d": "La nuova procedura valida in tutta Italia dal 2027: certificato unico, Valutazione di Base INPS e Progetto di Vita."},
    ],
    "riforma": {
        "regimeNazionale": "2027-01-01",
        "fonteUrl": "https://www.inps.it/it/it/inps-comunica/dossier/riforma-della-disabilita.html",
        "intro": "La Riforma della Disabilità (D.Lgs. 62/2024) vale in tutta Italia dal 2027. La procedura è unica e uguale ovunque: ecco come funziona.",
        "cosaCambia": [
            {"titolo": "Basta doppia domanda", "testo": "Il certificato medico introduttivo del tuo medico avvia DA SOLO la pratica: non serve più presentare una domanda amministrativa separata all'INPS."},
